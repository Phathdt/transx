...
ALTER TABLE transfers
    ADD COLUMN from_account_ref TEXT;

ALTER TABLE transfers
    ADD COLUMN to_account_ref TEXT;
...
ALTER TABLE transfers
    ALTER COLUMN from_account_ref SET NOT NULL;

ALTER TABLE transfers
    ADD CONSTRAINT transfers_from_account_ref_fkey FOREIGN KEY (from_account_ref) REFERENCES accounts (account_ref);
...
ALTER TABLE transfers
    DROP CONSTRAINT transfers_from_account_ref_fkey;

ALTER TABLE transfers
    DROP COLUMN to_account_ref;

ALTER TABLE transfers
    DROP COLUMN from_account_ref;

DROP INDEX uq_accounts_account_ref;

ALTER TABLE accounts
    DROP COLUMN account_ref;
